...
data AppEnv = AppEnv
  ...
  , _inHooksPrio :: Hs.Hooks    -- ^ Priority hooks: before sluice (tap-hold decisions)
  , _sluice      :: Sl.Sluice
  , _inHooks     :: Hs.Hooks    -- ^ Input hooks: after sluice (release emission)
